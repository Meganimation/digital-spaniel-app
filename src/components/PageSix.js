...
background: ${props.active ? "#19293A" : "#C5C9CD"};
text-align: center;
...
const [activeButton, setActiveButton] = React.useState([false, false, false])
  ...
  return (<>
    ...
    <HeadingWrapper> 
      ...
      <ButtonWrapper >
      <Button onClick={()=>{setActiveButton([!activeButton[0], false, false])}}/> <Button onClick={()=>{setActiveButton([false, !activeButton[1], false])}}/> <Button onClick={()=>{setActiveButton([false, false, !activeButton[2]])}}/> 
      </ButtonWrapper >
